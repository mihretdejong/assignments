...
//type=submit allows it to hear for the submit event with an enter event and not a click on the button
                ...
                <div className="resource-page-div">
                  <div className="resources-overlay">
                    <form onSubmit={props.handleSearch} className="search-box" >
                        ...
                        <h2>“A reader lives a thousand lives before he dies... The man who never reads lives only once.” 
